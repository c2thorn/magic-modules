...
func (r Resource) RequiredProperties() []*Type {
	return google.Select(r.Parameters, func(p *Type) bool {
		return p.Required
	})
}
...
func (r Resource) propertiesWithoutCustomUpdate(properties []*Type) []*Type {
	return google.Select(r.UserProperites(), func(p *Type) bool {
...
func (r Resource) UpdateBodyProperties() []*Type {
	updateProp := r.propertiesWithoutCustomUpdate(r.settableProperties())
