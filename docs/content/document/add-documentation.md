...
Documentation is autogenerated based on the [resource]({{< ref "/develop/add-resource" >}}) and [field]({{< ref "/develop/add-fields" >}}) configurations. This page describes how to add documentation to resources and fields.
